...
function Register() {
  ...
  const verifyDataHandler = (e) => {
    ...
    const nameVerify =
      (input.name === "firstName" || input.name === "lastName") && !nameResult;
    const localVerify =
      (input.name === "country" || input.name === "city") && !nameResult;
    ...
    const confirmPasswordVerify =
      input.name === "confirmPassword" && input.value !== userData.password;
